...
\item[Area Chairing] ~\newline
%
Action Editor for the \href{https://aclrollingreview.org/}{ACL Rolling Review} (oct. 2021, nov. 2021, jan. 2022, mar. 2022, sept. 2022, dec. 2022, jun. 2023)~\newline
ACL-IJCNLP 2021 (Summarization track), EMNLP 2022 (Summarization track), EMNLP 2023 (Summarization track).~\newline
